...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: We're asserting that the address contains a valid reference to a u32 variable.
    // We can safely create a mutable reference from the address and modify it.
